...
public class SingleRegister {
    ...
    private static class SingletonHolder {
        private static final SingleRegister singleRegister = new SingleRegister();

        private SingletonHolder() {
            System.out.println("SingletonHolder: " + singleRegister);
        }
    }

    private SingleRegister() {
        System.out.println("SingleRegister: " + SingletonHolder.singleRegister);

    }

    public static final SingleRegister getInstance() {
        System.out.println("SingleRegisterGetInstance: " + SingletonHolder.singleRegister);
        return SingletonHolder.singleRegister;
    }
